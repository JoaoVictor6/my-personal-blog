...
const USER_API_LINK = 'https://api.github.com/users/joaovictor6';
export const Github = async () => {
  const THREE_HOURS = (60 * 60) * 30
  const response = await fetch(USER_API_LINK, { next: { revalidate: THREE_HOURS } })
  const { name, avatar_url, bio, location, followers } = await response.json() as GithubUserResponse
  return (
<HoverCard>
      <HoverCardTrigger asChild>
          <Button variant="link">
            <a target="_blank" referrerPolicy="no-referrer" className="flex items-center gap-1" href="https://github.com/JoaoVictor6">
              <GithubLogo /> @joaovictor6
            </a>
          </Button>
      </HoverCardTrigger>
        ...
        <div className="flex justify-between space-x-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between">
              ...
              <small className="text-gray-500 flex items-center gap-1 text-sm font-medium leading-none">
